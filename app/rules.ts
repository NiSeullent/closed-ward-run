...
export type ZoneSpec={name:string;banner:string;fog:string;sky:string;ground:string;lampA:string;lampB:string;speedBonus:number;gapMin:number;gapMax:number;carBoost:number};
export const ZONES:ZoneSpec[]=[
 {name:'불야성 도심',banner:'불야성 도심 진입 — 네온이 너를 판다',fog:'#291934',sky:'#20152f',ground:'#1b1626',lampA:'#ff4aa6',lampB:'#46ccff',speedBonus:0,gapMin:17,gapMax:32,carBoost:0},
 {name:'주택가 골목',banner:'주택가 진입 — 조용히, 빨리',fog:'#1c1830',sky:'#161226',ground:'#211b20',lampA:'#ffb35c',lampB:'#8f7bff',speedBonus:1,gapMin:14,gapMax:26,carBoost:-1},
 {name:'심야 고속도로',banner:'고속도로 진입 — 속도를 올려!',fog:'#232031',sky:'#191722',ground:'#141420',lampA:'#46ccff',lampB:'#ff4aa6',speedBonus:4,gapMin:15,gapMax:28,carBoost:3},
 {name:'병원 구역',banner:'병원 구역 진입 — 빈 침대가 기다린다',fog:'#33141f',sky:'#241019',ground:'#251316',lampA:'#ff2b65',lampB:'#ffd671',speedBonus:2,gapMin:13,gapMax:24,carBoost:1},
];
